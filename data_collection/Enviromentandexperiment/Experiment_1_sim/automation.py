...
# ============================================================================
# CONFIGURATION - CORRECTED PATHS FOR YOUR STRUCTURE
# ============================================================================

# Your world files are in this location
WORLDS_DIR = Path("/home/hernan/gazebo_worlds/Rooms_exp/Exp5/generated_worlds_single_sensor")

# Plugin is here
PLUGIN_PATH = Path("/home/hernan/gazebo_worlds/lidar_plugin/build")

# Your scripts are here (or adjust if different)
...
# Temporary files (created by Gazebo)
LIDAR_SCAN_FILE = Path("/tmp/lidar_scan.txt")
LIDAR_CSV_OUTPUT = SCRIPTS_DIR / "lidar_scan.csv"

# Results directory - save here
RESULTS_DIR = WORLDS_DIR / "experiment_results"
RESULTS_DIR.mkdir(parents=True, exist_ok=True)

# Master CSV output
MASTER_CSV = RESULTS_DIR / "master_experiments.csv"

# Timing
GAZEBO_STARTUP = 5  # seconds to let Gazebo initialize
DATA_COLLECTION_TIME = 3  # seconds to collect stable data
GAZEBO_SHUTDOWN = 2  # seconds to shutdown cleanly
